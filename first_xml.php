...
$xml_dec="<fichierGlobal id=\"".$id_fichier."\">";
$rootELementStart = "<demandeConference>";
$rootElementEnd = "</demandeConference>";
$xml_doc= $xml_dec;
$xml_doc .= "<destinataire>".PHP_EOL;
$xml_doc .= $destinataire.PHP_EOL;
$xml_doc .= "</destinataire>".PHP_EOL;
$xml_doc .= "<expediteur> EDF </expediteur>".PHP_EOL;
...
<body>
	...
	<br />
		...
		<input type=button onclick=window.location.href="/docnum/envoi_fichier"; value=ENVOI envoyer un fichier />
</body>
</html>